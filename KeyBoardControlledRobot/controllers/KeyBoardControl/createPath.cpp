...
vector<char> createFirstPath();
vector<char> createNewPath(vector<int> currPos, directions currHeading, vector<int> targetPos);
...
vector<char> createFirstPath() {
    ...
    endingPoint.push_back(4);
    return createNewPath(startingPoint, SOUTH, endingPoint);
}
